...
doc.fontSize(25).text('Basic Pdf example', {
...
doc
    ...
    .text(lorem, {          // declaracion del texto
        ...
        lineGap: 4.0,       // cantidad de espacio que hay entre cada linea de texto
        wordSpacing: 2,     // antidad de espacio entre cada palabra en el texto
        characterSpacing: 1 // la cantidad de espacio entre cada carácter en el texto
    }) 
